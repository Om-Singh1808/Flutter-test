...
class _HomePageState extends State<HomePage> {
  ...
  NavigationDestination(
    icon: Icon(Icons.sensors_outlined, color: Color(0xFF666666)),
    selectedIcon: Icon(Icons.sensors_rounded, color: Color(0xFFFFD700)),
    label: 'Sensors',
  ),
  NavigationDestination(
    icon: Icon(Icons.folder_outlined, color: Color(0xFF666666)),
    selectedIcon: Icon(Icons.folder_open_rounded, color: Color(0xFFFFD700)),
    label: 'Documents',
  ),
],
        ),
